...
/**
 * Repository interface for managing mentorship cycles. Provides methods to query and manage
...
public interface MentorshipCycleRepository extends CrudRepository<MentorshipCycleEntity, Long> {
   ...
   */
  Optional<MentorshipCycleEntity> findByYearAndType(Year year, MentorshipType type);
