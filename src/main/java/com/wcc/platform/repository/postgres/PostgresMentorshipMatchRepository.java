...
/**
 * PostgreSQL implementation of MentorshipMatchRepository.
 * Manages confirmed mentorship matches in the database.
 */
@Repository
...
public class PostgresMentorshipMatchRepository implements MentorshipMatchRepository {
    ...
    private static final String SELECT_BY_ID =
        "SELECT * FROM mentorship_matches WHERE match_id = ?";

    private static final String SELECT_ACTIVE_BY_MENTOR =
        "SELECT * FROM mentorship_matches " +
        "WHERE mentor_id = ? AND match_status = 'active' " +
        "ORDER BY start_date DESC";

    private static final String SELECT_ACTIVE_BY_MENTEE =
        "SELECT * FROM mentorship_matches " +
    ...
    private MentorshipMatch mapRow(final ResultSet rs) throws SQLException {
        return MentorshipMatch.builder()
            ...
            .applicationId(rs.getObject("application_id") != null
                ? rs.getLong("application_id") : null)
            ...
            .expectedEndDate(rs.getDate("expected_end_date") != null
                ? rs.getDate("expected_end_date").toLocalDate() : null)
            ...
            .cancelledAt(rs.getTimestamp("cancelled_at") != null
