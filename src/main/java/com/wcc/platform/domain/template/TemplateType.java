...
public enum TemplateType {
    ...
    WELCOME_MENTORSHIP_LONG("welcome_mentorship_mentee_mentor_long_term.yml"),
    KICK_OFF_MEETING_LONG("kick_off_meeting_mentor_mentee_long_term.yml"),
    MENTEE_APP_RECEIVED_LONG("long_term_mentorship_application_received_mentee.yml"),
    ...
    POTENTIAL_MENTEES_LONG("list_potential_mentees_follow_up_mentor_long.yml"),
    ...
    MENTEE_TERMINATION_LONG("mentorship_termination_noshow_warning_mentee_long.yml"),
