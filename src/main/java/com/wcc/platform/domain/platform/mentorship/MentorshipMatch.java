...
/**
 * Domain entity representing a confirmed mentor-mentee pairing.
 * Corresponds to the mentorship_matches table in the database.
 * Created when the mentorship team confirms a match from an accepted application.
 */
@Data
@Builder
public class MentorshipMatch {
    ...
    public long getDaysRemaining() {
        ...
        final long days = java.time.temporal.ChronoUnit.DAYS.between(
            LocalDate.now(),
            expectedEndDate
        );
