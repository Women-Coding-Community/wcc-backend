...
/**
 * Domain entity representing a mentee's application to a specific mentor.
 * Corresponds to the mentee_applications table in the database.
 * Supports priority-based mentor selection where mentees can apply to multiple mentors
 * with ranking (1 = highest priority, 5 = lowest).
 */
@Data
@Builder
