...
/**
 * Domain entity representing a mentorship cycle. Corresponds to the mentorship_cycles table in the
 * database. Replaces hardcoded cycle logic with database-driven configuration.
 */
@Data
@Builder
