...
Stop the WCC backend app from Docker desktop and then start the application in your IDE in debug
mode.

**Note**: Make sure you have Docker daemon running locally to be able to run integration tests by
executing``docker ps``.
