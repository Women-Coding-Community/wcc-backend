    ...
    definitions: {
      memberSchema: {
        ...
        "properties": {
          ...
          "memberTypes": {
            ...
            "items": [
              {
                "type": "string",
                "enum": ["DIRECTOR", "LEADER", "EVANGELIST", "VOLUNTEER", "MENTOR", "MENTEE", "MEMBER", "SPEAKER", "COLLABORATOR"]
              }
            ]
          },
        ...
        "required": [
          ...
          "memberTypes",
          "images"
        ] // include email, slackDisplayName, country as required when there is a fix in API
      }
    }
