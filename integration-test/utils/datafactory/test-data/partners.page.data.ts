export const partnersPageData = {
    ...
    "introSection": {
      ...
      "items": [
        ...
        "Engage in sponsorships, event collaborations, mentorship programs, and other programs.",
